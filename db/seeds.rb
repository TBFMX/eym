...
unless Category.count > 0
	...
	@cat10.save	
	@cat11.save				
	Category.create(title: 'Camion de volteo', father_id: @cat1.id)
	Category.create(title: 'Gondolas', father_id: @cat1.id)
	Category.create(title: 'Plataformas', father_id: @cat1.id)
	Category.create(title: 'Camion de Basura', father_id: @cat1.id)
	Category.create(title: 'Retroexcavadoras', father_id: @cat1.id)
	Category.create(title: 'Compactadoras', father_id: @cat2.id)
	Category.create(title: 'Vibradores', father_id: @cat2.id)
	Category.create(title: 'Pavimentadoras', father_id: @cat2.id)
	Category.create(title: 'Motoconformadoras', father_id: @cat2.id)
	Category.create(title: 'Zanjadoras', father_id: @cat2.id)
	Category.create(title: 'Demolición y derribo', father_id: @cat2.id)
	Category.create(title: 'Grúas', father_id: @cat2.id)
	Category.create(title: 'Grúas articuladas', father_id: @cat2.id)
	Category.create(title: 'Grúas chatarreras', father_id: @cat2.id)
	Category.create(title: 'Excavadoras', father_id: @cat2.id)
	Category.create(title: 'Revolvedoras', father_id: @cat2.id)
	Category.create(title: 'Maquinaria pesada', father_id: @cat2.id)
	Category.create(title: 'Montacargas telescopico', father_id: @cat2.id)
	Category.create(title: 'Minicargadores', father_id: @cat2.id)
	Category.create(title: 'Cargadores frontales', father_id: @cat2.id)
	Category.create(title: 'Perforación', father_id: @cat2.id)
	Category.create(title: 'Cargadores sobre oruga', father_id: @cat2.id)
	Category.create(title: 'Cargadores sobre ruedas', father_id: @cat2.id)
	Category.create(title: 'Tractores', father_id: @cat3.id)
	Category.create(title: 'Equipo para agricultura', father_id: @cat3.id)
	Category.create(title: 'Bailarinas', father_id: @cat4.id)
	Category.create(title: 'Minicargadores', father_id: @cat4.id)
	Category.create(title: 'Dumpers', father_id: @cat5.id)
	Category.create(title: 'Track drill', father_id: @cat5.id)
	Category.create(title: 'Bulldozer', father_id: @cat5.id)
	Category.create(title: 'Maquinaria pesada', father_id: @cat5.id)
	Category.create(title: 'Cargadores frontales', father_id: @cat5.id)
	Category.create(title: 'Perforación', father_id: @cat5.id)
	Category.create(title: 'Cargadores sobre oruga', father_id: @cat5.id)
	Category.create(title: 'Cargadores sobre ruedas', father_id: @cat5.id)
	Category.create(title: 'Compresores', father_id: @cat6.id)
	Category.create(title: 'Montacargas', father_id: @cat7.id)
	Category.create(title: 'Brazo articulado', father_id: @cat7.id)
	Category.create(title: 'Montacargas telescopico', father_id: @cat7.id)
	Category.create(title: 'Minicargadores', father_id: @cat7.id)
	Category.create(title: 'Cargadores frontales', father_id: @cat7.id)
	Category.create(title: 'Recicladoras', father_id: @cat10.id)
	Category.create(title: 'Manejo de chatarra', father_id: @cat10.id)
	Category.create(title: 'Telescópicos', father_id: @cat11.id)
	Category.create(title: 'Barredoras', father_id: @cat11.id)
	Category.create(title: 'Equipo industrial', father_id: @cat11.id)
	Category.create(title: 'Transporte de tierra', father_id: @cat11.id)
	Category.create(title: 'Transporte de materiales', father_id: @cat11.id)
	Category.create(title: 'Tratamiento de agua', father_id: @cat11.id)
	Category.create(title: 'Trascabo', father_id: @cat11.id)
	Category.create(title: 'Todo terreno', father_id: @cat11.id)
	Category.create(title: 'Manejo de materiales', father_id: @cat11.id)
	Category.create(title: 'Vehiculos pesados', father_id: @cat11.id)
	Category.create(title: 'Manejo de materiales', father_id: @cat11.id)
	Category.create(title: 'Máquinas para extender', father_id: @cat11.id)
	Category.create(title: 'Maquinas para compactar', father_id: @cat11.id)
	Category.create(title: 'Plumas', father_id: @cat11.id)
	Category.create(title: 'Equipos de cargas', father_id: @cat11.id)
	Category.create(title: 'Equipos de elevación', father_id: @cat11.id)
	Category.create(title: 'Escrepas', father_id: @cat11.id)
	Category.create(title: 'Trascabo', father_id: @cat11.id)
	Category.create(title: 'Carretera', father_id: @cat11.id)		
end
##################################################################